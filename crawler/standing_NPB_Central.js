function crawl(){
  ...
  request("http://sports.news.naver.com/wbaseball/record/index.nhn?category=npb&league=CL&year=2017", function(error, response, body) {
    console.log('request is '+"http://sports.news.naver.com/wbaseball/record/index.nhn?category=npb&league=CL&year=2017");
    if(error) {
